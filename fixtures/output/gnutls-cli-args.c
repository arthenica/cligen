...
static const struct option long_options[] =
{
  ...
  { "mtu", required_argument, NULL, CHAR_MAX + 18 },
  { "crlf", no_argument, NULL, CHAR_MAX + 19 },
  { "fastopen", no_argument, NULL, CHAR_MAX + 20 },
  { "x509fmtder", no_argument, NULL, CHAR_MAX + 21 },
  { "print-cert", no_argument, NULL, CHAR_MAX + 22 },
  { "save-cert", required_argument, NULL, CHAR_MAX + 23 },
  { "save-ocsp", required_argument, NULL, CHAR_MAX + 24 },
  { "save-ocsp-multi", required_argument, NULL, CHAR_MAX + 25 },
  { "save-server-trace", required_argument, NULL, CHAR_MAX + 26 },
  { "save-client-trace", required_argument, NULL, CHAR_MAX + 27 },
  { "dh-bits", required_argument, NULL, CHAR_MAX + 28 },
  { "priority", required_argument, NULL, CHAR_MAX + 29 },
  { "x509cafile", required_argument, NULL, CHAR_MAX + 30 },
  { "x509crlfile", required_argument, NULL, CHAR_MAX + 31 },
  { "x509keyfile", required_argument, NULL, CHAR_MAX + 32 },
  { "x509certfile", required_argument, NULL, CHAR_MAX + 33 },
  { "rawpkkeyfile", required_argument, NULL, CHAR_MAX + 34 },
  { "rawpkfile", required_argument, NULL, CHAR_MAX + 35 },
  { "srpusername", required_argument, NULL, CHAR_MAX + 36 },
  { "srppasswd", required_argument, NULL, CHAR_MAX + 37 },
  { "pskusername", required_argument, NULL, CHAR_MAX + 38 },
  { "pskkey", required_argument, NULL, CHAR_MAX + 39 },
  { "port", required_argument, NULL, 'p' },
  { "insecure", no_argument, NULL, CHAR_MAX + 40 },
  { "verify-allow-broken", no_argument, NULL, CHAR_MAX + 41 },
  { "ranges", no_argument, NULL, CHAR_MAX + 42 },
  { "benchmark-ciphers", no_argument, NULL, CHAR_MAX + 43 },
  { "benchmark-tls-kx", no_argument, NULL, CHAR_MAX + 44 },
  { "benchmark-tls-ciphers", no_argument, NULL, CHAR_MAX + 45 },
  { "list", no_argument, NULL, 'l' },
  { "priority-list", no_argument, NULL, CHAR_MAX + 46 },
  { "noticket", no_argument, NULL, CHAR_MAX + 47 },
  { "srtp-profiles", required_argument, NULL, CHAR_MAX + 48 },
  { "alpn", required_argument, NULL, CHAR_MAX + 49 },
  { "compress-cert", required_argument, NULL, CHAR_MAX + 50 },
  { "heartbeat", no_argument, NULL, 'b' },
  { "recordsize", required_argument, NULL, CHAR_MAX + 51 },
  { "disable-sni", no_argument, NULL, CHAR_MAX + 52 },
  { "disable-extensions", no_argument, NULL, CHAR_MAX + 53 },
  { "single-key-share", no_argument, NULL, CHAR_MAX + 54 },
  { "post-handshake-auth", no_argument, NULL, CHAR_MAX + 55 },
  { "inline-commands", no_argument, NULL, CHAR_MAX + 56 },
  { "inline-commands-prefix", required_argument, NULL, CHAR_MAX + 57 },
  { "provider", required_argument, NULL, CHAR_MAX + 58 },
  { "fips140-mode", no_argument, NULL, CHAR_MAX + 59 },
  { "list-config", no_argument, NULL, CHAR_MAX + 60 },
  { "logfile", required_argument, NULL, CHAR_MAX + 61 },
  { "keymatexport", required_argument, NULL, CHAR_MAX + 62 },
  { "keymatexportsize", required_argument, NULL, CHAR_MAX + 63 },
  { "waitresumption", no_argument, NULL, CHAR_MAX + 64 },
  { "ca-auto-retrieve", no_argument, NULL, CHAR_MAX + 65 },
  { "no-ca-auto-retrieve", no_argument, NULL, CHAR_MAX + 66 },
