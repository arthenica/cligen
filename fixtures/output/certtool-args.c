...
static const struct option long_options[] =
{
  ...
  { "certificate-info", no_argument, NULL, 'i' },
  { "pubkey-info", no_argument, NULL, CHAR_MAX + 3 },
  { "generate-self-signed", no_argument, NULL, 's' },
  { "generate-certificate", no_argument, NULL, 'c' },
  { "generate-proxy", no_argument, NULL, CHAR_MAX + 4 },
  { "update-certificate", no_argument, NULL, 'u' },
  { "fingerprint", no_argument, NULL, CHAR_MAX + 5 },
  { "key-id", no_argument, NULL, CHAR_MAX + 6 },
  { "certificate-pubkey", no_argument, NULL, CHAR_MAX + 7 },
  { "v1", no_argument, NULL, CHAR_MAX + 8 },
  { "sign-params", required_argument, NULL, CHAR_MAX + 9 },
  { "crq-info", no_argument, NULL, CHAR_MAX + 10 },
  { "generate-request", no_argument, NULL, 'q' },
  { "no-crq-extensions", no_argument, NULL, CHAR_MAX + 11 },
  { "p12-info", no_argument, NULL, CHAR_MAX + 12 },
  { "p12-name", required_argument, NULL, CHAR_MAX + 13 },
  { "to-p12", no_argument, NULL, CHAR_MAX + 14 },
  { "key-info", no_argument, NULL, 'k' },
  { "p8-info", no_argument, NULL, CHAR_MAX + 15 },
  { "to-rsa", no_argument, NULL, CHAR_MAX + 16 },
  { "generate-privkey", no_argument, NULL, 'p' },
  { "key-type", required_argument, NULL, CHAR_MAX + 17 },
  { "bits", required_argument, NULL, CHAR_MAX + 18 },
  { "curve", required_argument, NULL, CHAR_MAX + 19 },
  { "sec-param", required_argument, NULL, CHAR_MAX + 20 },
  { "to-p8", no_argument, NULL, CHAR_MAX + 21 },
  { "pkcs8", no_argument, NULL, '8' },
  { "provable", no_argument, NULL, CHAR_MAX + 22 },
  { "verify-provable-privkey", no_argument, NULL, CHAR_MAX + 23 },
  { "seed", required_argument, NULL, CHAR_MAX + 24 },
  { "crl-info", no_argument, NULL, 'l' },
  { "generate-crl", no_argument, NULL, CHAR_MAX + 25 },
  { "verify-crl", no_argument, NULL, CHAR_MAX + 26 },
  { "verify-chain", no_argument, NULL, 'e' },
  { "verify", no_argument, NULL, CHAR_MAX + 27 },
  { "verify-hostname", required_argument, NULL, CHAR_MAX + 28 },
  { "verify-email", required_argument, NULL, CHAR_MAX + 29 },
  { "verify-purpose", required_argument, NULL, CHAR_MAX + 30 },
  { "verify-allow-broken", no_argument, NULL, CHAR_MAX + 31 },
  { "verify-profile", required_argument, NULL, CHAR_MAX + 32 },
  { "p7-generate", no_argument, NULL, CHAR_MAX + 33 },
  { "p7-sign", no_argument, NULL, CHAR_MAX + 34 },
  { "p7-detached-sign", no_argument, NULL, CHAR_MAX + 35 },
  { "p7-include-cert", no_argument, NULL, CHAR_MAX + 36 },
  { "no-p7-include-cert", no_argument, NULL, CHAR_MAX + 37 },
  { "p7-time", no_argument, NULL, CHAR_MAX + 38 },
  { "no-p7-time", no_argument, NULL, CHAR_MAX + 39 },
  { "p7-show-data", no_argument, NULL, CHAR_MAX + 40 },
  { "no-p7-show-data", no_argument, NULL, CHAR_MAX + 41 },
  { "p7-info", no_argument, NULL, CHAR_MAX + 42 },
  { "p7-verify", no_argument, NULL, CHAR_MAX + 43 },
  { "smime-to-p7", no_argument, NULL, CHAR_MAX + 44 },
  { "generate-dh-params", no_argument, NULL, CHAR_MAX + 45 },
  { "get-dh-params", no_argument, NULL, CHAR_MAX + 46 },
  { "dh-info", no_argument, NULL, CHAR_MAX + 47 },
  { "load-privkey", required_argument, NULL, CHAR_MAX + 48 },
  { "load-pubkey", required_argument, NULL, CHAR_MAX + 49 },
  { "load-request", required_argument, NULL, CHAR_MAX + 50 },
  { "load-certificate", required_argument, NULL, CHAR_MAX + 51 },
  { "load-ca-privkey", required_argument, NULL, CHAR_MAX + 52 },
  { "load-ca-certificate", required_argument, NULL, CHAR_MAX + 53 },
  { "load-crl", required_argument, NULL, CHAR_MAX + 54 },
  { "load-data", required_argument, NULL, CHAR_MAX + 55 },
  { "password", required_argument, NULL, CHAR_MAX + 56 },
  { "null-password", no_argument, NULL, CHAR_MAX + 57 },
  { "empty-password", no_argument, NULL, CHAR_MAX + 58 },
  { "hex-numbers", no_argument, NULL, CHAR_MAX + 59 },
  { "cprint", no_argument, NULL, CHAR_MAX + 60 },
  { "rsa", no_argument, NULL, CHAR_MAX + 61 },
  { "dsa", no_argument, NULL, CHAR_MAX + 62 },
  { "ecc", no_argument, NULL, CHAR_MAX + 63 },
  { "ecdsa", no_argument, NULL, CHAR_MAX + 64 },
  { "hash", required_argument, NULL, CHAR_MAX + 65 },
  { "salt-size", required_argument, NULL, CHAR_MAX + 66 },
  ...
  { "disable-quick-random", no_argument, NULL, CHAR_MAX + 73 },
  { "template", required_argument, NULL, CHAR_MAX + 74 },
  { "stdout-info", no_argument, NULL, CHAR_MAX + 75 },
  { "ask-pass", no_argument, NULL, CHAR_MAX + 76 },
  { "pkcs-cipher", required_argument, NULL, CHAR_MAX + 77 },
  { "provider", required_argument, NULL, CHAR_MAX + 78 },
  { "text", no_argument, NULL, CHAR_MAX + 79 },
  { "no-text", no_argument, NULL, CHAR_MAX + 80 },
